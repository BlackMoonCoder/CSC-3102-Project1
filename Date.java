...
public class Date implements DateAPI, Comparable<Date> {
	 ...
	 * @return true when this date is the same as the specified data; otherwise,
	 *         false
	 */
	 ...
	 * 
	 * @param d a Gregorian date
	 * @return a number less than 0 when this Gregorian date comes before the
	 *         specified Gregorian date; a number greater than 0 when this Gregorian
	 *         date comes after the specified Gregorian date; otherwise, 0.
	 */
